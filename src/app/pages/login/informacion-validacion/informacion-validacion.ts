...
export class InformacionValidacionPage implements OnInit {
    ...
    registrarUsuario() {
        ...
        this.paciente.fechaNacimiento = this.formRegistro.controls.fechaNacimiento.value;
        this.paciente.nombre = this.formRegistro.controls.nombre.value;
        this.paciente.apellido = this.formRegistro.controls.apellido.value;
